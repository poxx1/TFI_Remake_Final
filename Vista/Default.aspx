...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <main>
        <section class="row" aria-labelledby="aspnetTitle">
            ...
            <h2>Pagina de inicio</h2><hr />
            <p>Say IT es una plataforma que brinda servicios a personas con discapacidades auditivas.
            ...
            <p>Sin mas pretextos, le damos la bienvenida al sitio!</p>
        </section>
