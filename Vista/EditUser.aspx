...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <main aria-labelledby="title">
        <div>
            ...
            <asp:TextBox ID="TextBox1" runat="server" required="required"></asp:TextBox><br />
            ...
            <asp:TextBox ID="TextBox3" runat="server" required="required"></asp:TextBox><br />
            <asp:Label ID="Label5" runat="server" Text="Nombre de usuario"></asp:Label><br />
            <asp:TextBox ID="TextBox4" runat="server" required="required"></asp:TextBox><br />
            <asp:Label ID="Label6" runat="server" Text="Password"></asp:Label><br />
            <asp:TextBox ID="TextBox5" runat="server" required="required"></asp:TextBox><br />
            <asp:Label ID="Label7" runat="server" Text="Email"></asp:Label><br />
            <asp:TextBox ID="TextBox6" runat="server" required="required"></asp:TextBox><br />
            <asp:Label ID="Label8" runat="server" Text="Telefono"></asp:Label><br />
            <asp:TextBox ID="TextBox7" runat="server" required="required"></asp:TextBox><br />
            <asp:Label ID="Label9" runat="server" Text="Direccion"></asp:Label><br />
            <asp:TextBox ID="TextBox8" runat="server" required="required"></asp:TextBox><br><br />
             <hr />
