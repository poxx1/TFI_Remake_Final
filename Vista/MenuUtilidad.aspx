...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <main aria-labelledby="title">
        <div>
            <h2 id="title" runat="server">Menu de utilidades</h2>
        </div>
        <hr />
        <div>
            <h3 id="title2" runat="server">Seccion del Administrador</h3>
        ...
        <hr />
        <div>
            <h3 id="title3" runat="server">Seccion del WebMaster</h3>
