...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <main aria-labelledby="title">
        <header>
            <h2 id="title" runat="server">Menu del Interprete</h2>
        </header>
        <hr>
        <div><h3 id="title2" runat="server">Seccion del Interprete</h3>
            <asp:Button ID="Button1" runat="server" Text="Interprete virtual" OnClick="Button1_Click" />
        </div>
        <hr>
        <div><h3 id="title3" runat="server">Seccion las traducciones</h3>
