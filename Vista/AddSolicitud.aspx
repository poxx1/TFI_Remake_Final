...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <main aria-labelledby="title">
        <div>
            ...
            <br />
            <asp:TextBox ID="TextBox1" runat="server" Width="200px" required="required"></asp:TextBox>
            <br />
            <br />
            <asp:Label ID="Label3" runat="server" Text="Descripcion"></asp:Label><br />
            <asp:TextBox ID="TextBox2" runat="server" Width="200px" required="required"></asp:TextBox>
            <hr />
