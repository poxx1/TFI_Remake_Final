...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <main aria-labelledby="title">
        <div>
           <h3 id="title" runat="server">Servicios Web</h3><hr />
            <h4 id="title2" runat="server">WebService 1 - Solicitudes aprobadas</h4><br />
            ...
            <hr />
            <h4 id="title3" runat="server">WebService 2 - Solicitudes pendientes</h4><br />
            ...
            <hr />
            <h4 id="title4" runat="server">WebService 3 - Cantidad total de solicitudes</h4><br />
